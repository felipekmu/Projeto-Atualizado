...
namespace Foodball
{
    ...
    public int Salvar()
    {
        ...
        try
        {
            ...
            BD._sql = "DELETE FROM PRATOS WHERE Buscar_pratos = " + id_AdicionarPratos;
        ...
        try
        {
            ...
            BD._sql = "UPDATE ADICIONAR_PRATOS SET Nome = '" + nome + "', Preco = '" + preco.Replace(",",".") + "', Tipo = '" + tipo + "' where id_AdicionarPratos = " + id_AdicionarPratos;
            ...
            {
                MessageBox.Show("Erro ao alterar pratos, contate o desenvolvedor!", "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
